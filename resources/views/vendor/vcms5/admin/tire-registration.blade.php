    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>{!! Lang::get('vcms.tire_registration') !!}
                    @if($registration->id > 0)
                    <a href="/admin/registrations/print-tire-registration?id={!! $registration->id !!}"><i class="fa fa-file-pdf-o"></i> Download PDF</a>
                    @endif
                </h5>
    ...
    <script>
        ...
        $("#add_note").click(function(){
            bootbox.dialog({
                        ...
                        '<div class="col-md-12">' +
                        '<form id="note_form" name="note_form" method="post" action="/admin/savetirenote">' +
                        '<?php echo csrf_field(); ?>' +
